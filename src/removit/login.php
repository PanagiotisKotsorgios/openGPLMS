...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // ── Rate Limiting ────────────────────────────────────────────────────────
    // Αποτρέπει brute force — μετά από 5 αποτυχίες, lockout 15 λεπτών.
    if (!loginCheckRateLimit($ip)) {
        $remaining = loginRemainingSeconds($ip);
        $mins = ceil($remaining / 60);
        $error = "Πολλές αποτυχημένες προσπάθειες. Δοκιμάστε ξανά σε {$mins} λεπτό(ά).";
        ...
        if ($user && password_verify($password, $user['password'])) {
            ...
            // Αναγέννηση session ID μετά την επιτυχή αυθεντικοποίηση —
            // αποτρέπει επίθεση session fixation όπου ο attacker έχει ήδη
            // γνωρίσει το παλιό session ID πριν το login.
            session_regenerate_id(true);

            loginClearAttempts($ip); // Μηδενισμός αποτυχιών μετά από επιτυχή login
            ...
            $attemptsLeft = LOGIN_MAX_ATTEMPTS - ($_SESSION['login_attempts_' . md5($ip)]['count'] ?? 0);
...
<title>Σύνδεση — Σύστημα Διαχείρισης Βιβλιοθήκης — openGPLMS v1.0</title>
...
<div class="left-panel">
    <div class="left-brand">
        <img src="../assets/opengplms-logo.png" alt="openGPLMS"
             style="height:48px;width:auto;display:block;filter:brightness(0) invert(1) opacity(0.88)">
    </div>

    <div class="left-headline">
        <div class="eyebrow">Open Source Library Management System</div>
        <h1>
            Manage your library<br>
            with clarity <em>&amp;</em><br>
            confidence.
        </h1>
        <p style="color:rgba(200,169,110,0.9);margin-bottom:10px;font-size:13px;letter-spacing:0.5px;">openGPLMS &nbsp;·&nbsp; General Purpose Library Management System</p>
        <p>Free &amp; open-source. Self-hosted. Built for libraries of all sizes. Manage, search and explore your entire collection.</p>
    </div>
...
<div class="right-panel">
    ...
    <div class="form-area">
        ...
        <a href="catalog_public.php" class="btn-public">
    ...
    <div class="right-footer">
        <div class="footer-links">
            ...
            <a href="https://www.github.com/openGPLMS/openGPLMS/contact-us/">Επικοινωνία</a>
        </div>
        <div class="footer-copy">
            &copy; <?= date('Y') ?> openGPLMS &nbsp;·&nbsp; openGPLMS — General Purpose Library Management System v1.0
        </div>
    </div>
</div>
...
<div class="custom-modal-overlay" id="forgotModal">
    <div class="custom-modal">
        ...
        <div class="modal-note">
            ...
            <a href="mailto:contribute@opengplms.org">contribute@opengplms.org</a>
        </div>
    </div>
</div>
    ...
    <div class="custom-modal">
        ...
        <div>
            <div class="help-item">
                ...
                <div class="help-a">Χρησιμοποιήστε την επιλογή "Ξεχάσατε τον κωδικό;" κάτω από το πεδίο κωδικού, ή επικοινωνήστε με τον διαχειριστή στο contribute@opengplms.org.</div>
            </div>
            <div class="help-item">
                <div class="help-q" onclick="toggleHelp(this)">
...
<div class="custom-modal-overlay" id="accessibilityModal">
    <div class="custom-modal">
        ...
        <div class="legal-content" style="max-height:200px">
            ...
            <p>Εάν αντιμετωπίζετε πρόβλημα προσβασιμότητας, επικοινωνήστε στο contribute@opengplms.org</p>
        </div>
    </div>
</div>
...
<div class="legal-modal-overlay" id="legal-modal-privacy">
    <div class="legal-modal-box">
        ...
        <div class="legal-modal-body">
            ...
            <h4>4. Δικαιώματα</h4>
            <p>Μπορείτε να ζητήσετε διόρθωση ή διαγραφή των δεδομένων σας επικοινωνώντας με τον διαχειριστή. Για ερωτήματα GDPR: <a href="mailto:contribute@opengplms.org" style="color:var(--gold)">contribute@opengplms.org</a></p>
...
<div class="legal-modal-overlay" id="legal-modal-terms">
    <div class="legal-modal-box">
        ...
        <div class="legal-modal-body">
            ...
            <h4>4. Ευθύνη</h4>
            <p>Η openGPLMS δεν ευθύνεται για τυχαία απώλεια δεδομένων ή διακοπή λειτουργίας. Συνιστάται η τακτική αποθήκευση σημαντικών πληροφοριών.</p>
