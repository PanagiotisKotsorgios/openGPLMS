...
<title>openGPLMS — Σύστημα Διαχείρισης Βιβλιοθήκης</title>
...
html::after {
    ...
    background:
        ...
        radial-gradient(ellipse 80% 60% at 30% 50%, rgba(200,169,110,0.06) 0%, transparent 70%);
    pointer-events: none;
}
...
.brand-logo-img {
    ...
    width: auto;
    filter: drop-shadow(0 2px 12px rgba(200,169,110,0.25));
    transition: transform 0.25s, filter 0.25s;
}
.brand-logo-link:hover .brand-logo-img {
    transform: scale(1.04);
    filter: drop-shadow(0 4px 20px rgba(200,169,110,0.45));
}
...
.badge-donate:hover {
    ...
    color: #fff;
    border-color: rgba(220,100,120,0.6);
}
...
.quote-attr {
    ...
    color: rgba(200,169,110,0.8); text-transform: uppercase; margin-bottom: 22px;
}
...
.modal-box {
    background: #ffffff; border: 1px solid rgba(200,169,110,0.2);
...
.input-wrap input:focus { background: #fff; border-color: var(--gold); box-shadow: 0 0 0 3px rgba(200,169,110,0.15); }
...
.btn-signin:hover { transform: translateY(-2px); box-shadow: 0 8px 28px rgba(200,169,110,0.3); }
...
.custom-modal {
    background: #fff; border: 1px solid rgba(200,169,110,0.2);
...
.modal-input {
    width: 100%; background: rgba(0,0,0,0.02); border: 1px solid rgba(200,169,110,0.2);
...
.modal-input:focus { border-color: rgba(200,169,110,0.5); box-shadow: 0 0 0 3px rgba(200,169,110,0.1); }
...
.btn-modal-submit:hover { transform: translateY(-1px); box-shadow: 0 6px 20px rgba(200,169,110,0.25); }
...
<div class="landing">
    ...
    <div class="top-bar-wrapper">
        <a href="https://github.com/openGPLMS/openGPLMS" target="_blank" rel="noopener" class="brand-logo-link">
            <img src="assets/opengplms-logo.png" alt="openGPLMS" class="brand-logo-img">
        </a>
        <div class="os-badges">
            <a href="https://github.com/openGPLMS/openGPLMS" target="_blank" rel="noopener" class="badge-btn badge-github">
                <i class="fab fa-github"></i> GitHub
            </a>
            <a href="https://github.com/openGPLMS/openGPLMS/blob/main/CONTRIBUTING.md" target="_blank" rel="noopener" class="badge-btn badge-contribute">
                <i class="fas fa-code-pull-request"></i> Contribute
            </a>
            <a href="https://ko-fi.com/opengplms" target="_blank" rel="noopener" class="badge-btn badge-donate">
    ...
    <div class="center-content">
        <div class="eyebrow">Open Source · Free · Community Driven</div>
        ...
        <div class="quote-attr">openGPLMS &nbsp;·&nbsp; General Purpose Library Management System</div>

        <p class="intro-text">
            openGPLMS is a free, open-source library management system for libraries of all sizes.
            Browse the public catalogue, manage your collection, and contribute to the project.
        </p>

        <div class="cta-group">
            <a href="catalog_public.php" class="btn-catalog-entry">
                <i class="fas fa-book-open"></i> Browse Public Catalogue
            </a>
            <a href="https://github.com/openGPLMS/openGPLMS" target="_blank" rel="noopener" class="btn-github-entry">
                <i class="fab fa-github"></i> View on GitHub
            </a>
        </div>

        <div class="feature-pills">
            <span><i class="fas fa-lock-open"></i> Open Source</span>
            <span><i class="fas fa-globe"></i> Multilingual</span>
            <span><i class="fas fa-shield-alt"></i> Secure</span>
            <span><i class="fas fa-download"></i> Self-Hosted</span>
        </div>
    </div>
    ...
    <footer class="site-footer">
        <div class="footer-links">
            <button onclick="openLoginModal()">Staff Login</button>
            <a href="https://github.com/openGPLMS/openGPLMS" target="_blank" rel="noopener"><i class="fab fa-github"></i> GitHub</a>
            <a href="https://github.com/openGPLMS/openGPLMS/blob/main/CONTRIBUTING.md" target="_blank" rel="noopener"><i class="fas fa-hands-helping"></i> Contribute</a>
            <a href="https://github.com/openGPLMS/openGPLMS/issues" target="_blank" rel="noopener"><i class="fas fa-bug"></i> Report Issue</a>
            <a href="https://ko-fi.com/opengplms" target="_blank" rel="noopener"><i class="fas fa-heart"></i> Donate</a>
            <button onclick="openCustomModal('helpModal')">FAQ</button>
        </div>
        <div class="footer-copy">
            &copy; <?= date('Y') ?> openGPLMS &nbsp;·&nbsp; General Purpose Library Management System &nbsp;·&nbsp; MIT License &nbsp;·&nbsp; v1.0
        </div>
    </footer>
...
<div class="custom-modal-overlay" id="forgotModal">
    <div class="custom-modal">
        ...
        <div class="modal-note">
            Ή επικοινωνήστε στο <a href="mailto:contribute@opengplms.org">contribute@opengplms.org</a>
        </div>
    </div>
</div>
    ...
    <div class="custom-modal">
        ...
        <div>
            <div class="help-item">
                ...
                <div class="help-a">Χρησιμοποιήστε την επιλογή «Ξεχάσατε τον κωδικό;» στο modal σύνδεσης, ή επικοινωνήστε με τον διαχειριστή στο contribute@opengplms.org.</div>
            </div>
            <div class="help-item">
    ...
    <div class="custom-modal">
        ...
        <div>
            ...
            <div class="help-item">
                ...
                <div class="help-a">Εάν αντιμετωπίζετε πρόβλημα προσβασιμότητας, επικοινωνήστε στο contribute@opengplms.org</div>
            </div>
        </div>
    </div>
</div>
...
<div class="legal-modal-overlay" id="legal-modal-privacy">
    <div class="legal-modal-box">
        ...
        <div class="legal-modal-body">
            ...
            <h4>4. Δικαιώματα</h4>
            <p>Μπορείτε να ζητήσετε διόρθωση ή διαγραφή των δεδομένων σας επικοινωνώντας στο <a href="mailto:contribute@opengplms.org" style="color:var(--gold)">contribute@opengplms.org</a></p>
...
<div class="legal-modal-overlay" id="legal-modal-terms">
    <div class="legal-modal-box">
        ...
        <div class="legal-modal-body">
            ...
            <p>Η χρήση του συστήματος προϋποθέτει αποδοχή των παρόντων όρων. Το σύστημα προορίζεται αποκλειστικά για εξουσιοδοτημένους χρήστες της openGPLMS.</p>
            ...
            <h4>4. Ευθύνη</h4>
            <p>Η openGPLMS δεν ευθύνεται για τυχαία απώλεια δεδομένων ή διακοπή λειτουργίας.</p>
        </div>
    </div>
</div>
