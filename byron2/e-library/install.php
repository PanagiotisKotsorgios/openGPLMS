...
try {
     ...
     */
    $adminHash    = password_hash('byronadm123',    PASSWORD_DEFAULT);
    $employeeHash = password_hash('byronlib123', PASSWORD_DEFAULT);
    ...
    ok("Default users inserted &nbsp;<code>byronadm / byronadm123</code> &nbsp;&amp;&nbsp; <code>byronlib / byronlib123</code>");
