...
<title data-i18n="page_title">Ψηφιακός Κατάλογος — Messolonghi Byron Society</title>
...
════════════════════════════════════════════ -->
<div class="topbar">
    <a href="https://www.messolonghibyronsociety.gr/" target="_blank" rel="noopener" class="topbar-brand">
        <img src="assets/byron.png" alt="Βυρωνική Εταιρεία">
        <div class="brand-text">
            <div class="brand-name">THE MESSOLONGHI BYRON SOCIETY</div>
            <div class="brand-sub">ΒΥΡΩΝΙΚΗ ΕΤΑΙΡΕΙΑ ΙΕΡΑΣ ΠΟΛΕΩΣ ΜΕΣΟΛΟΓΓΙΟΥ</div>
            <div class="brand-sub2">International Research Center for Lord Byron &amp; Philhellenism</div>
        </div>
    </a>
...
<footer>
    <div class="footer-bottom">
        <div class="footer-copy">
            © <?= date('Y') ?> <span data-i18n="footer_rights">Messolonghi Byron Society. All rights reserved unless otherwise stated.</span>
        </div>
        <div class="footer-legal">
            <a href="#" onclick="openModal('privacy'); return false;"      data-i18n="footer_privacy">Πολιτική Απορρήτου</a>
            <div class="footer-legal-sep"></div>
            <a href="#" onclick="openModal('terms'); return false;"        data-i18n="footer_terms">Όροι Χρήσης</a>
            <div class="footer-legal-sep"></div>
            <a href="#" onclick="openModal('cookies'); return false;"      data-i18n="footer_cookies">Πολιτική Cookies</a>
            <div class="footer-legal-sep"></div>
            <a href="#" onclick="openModal('accessibility'); return false;" data-i18n="footer_accessibility">Προσβασιμότητα</a>
            <div class="footer-legal-sep"></div>
            <a href="#" onclick="openModal('contact'); return false;"      data-i18n="footer_contact">Επικοινωνία</a>
        </div>
    </div>
...
<div class="modal-overlay" id="modal-contact">
    <div class="legal-modal">
        ...
        <div class="legal-modal-body">
            <h4 data-i18n="contact_h1">Βυρωνική Εταιρεία Μεσολογγίου</h4>
            <p data-i18n="contact_p1">Επικοινωνήστε μαζί μας:</p>
            <ul>
                <li><strong data-i18n="contact_website_label">Ιστοσελίδα:</strong> <a href="https://www.messolonghibyronsociety.gr/" target="_blank" style="color:var(--gold)">messolonghibyronsociety.gr</a></li>
                <li><strong data-i18n="contact_address_label">Διεύθυνση:</strong> <span data-i18n="contact_address">Βυρώνειο κτήριο, Πλώσταινα, Μεσολόγγι</span></li>
            </ul>
        </div>
    </div>
</div>
...
const translations = {
    el: {
        page_title:            'Ψηφιακός Κατάλογος — Messolonghi Byron Society',
        ...
        footer_rights:         'Βυρωνική Εταιρεία Μεσολογγίου. Όλα τα δικαιώματα διατηρούνται.',
        ...
        contact_title:'Επικοινωνία', contact_h1:'Βυρωνική Εταιρεία Μεσολογγίου', contact_p1:'Επικοινωνήστε μαζί μας:', contact_website_label:'Ιστοσελίδα:', contact_address_label:'Διεύθυνση:', contact_address:'Βυρώνειο κτήριο, Πλώσταινα, Μεσολόγγι',
    },
    en: {
        page_title:            'Digital Catalogue — Messolonghi Byron Society',
        ...
        modal_status:          'Status',
        footer_rights:         'Mesolonghi Byron Society. All rights reserved.',
        ...
        contact_title:'Contact', contact_h1:'Byron Society of Mesolonghi', contact_p1:'Get in touch with us:', contact_website_label:'Website:', contact_address_label:'Address:', contact_address:'Byron Building, Plostaina, Mesolonghi',
    }
};
...
<div class="custom-modal-overlay" id="forgotModal" style="position:fixed;inset:0;z-index:10000;background:rgba(255,255,255,0.7);backdrop-filter:blur(8px);display:flex;align-items:center;justify-content:center;opacity:0;pointer-events:none;transition:opacity 0.25s;">
    <div class="custom-modal" style="background:#fff;border:1px solid rgba(201,168,76,0.2);border-radius:14px;padding:36px 40px;max-width:480px;width:90%;position:relative;transform:translateY(20px) scale(0.97);transition:transform 0.25s;box-shadow:0 20px 40px rgba(0,0,0,0.12);">
        ...
        <div style="font-size:12px;color:#6c757d;text-align:center;margin-top:12px">Ή επικοινωνήστε στο <a href="mailto:byronlib@gmail.com" style="color:#c9a84c">byronlib@gmail.com</a></div>
    </div>
</div>
