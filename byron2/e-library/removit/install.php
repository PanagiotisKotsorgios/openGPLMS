...
try {
    ...
    $employeeHash = password_hash('byron123', PASSWORD_DEFAULT);

    $stmt = $pdo->prepare("
    INSERT INTO `" . TABLE_PREFIX . "users` 
        (`id`, `username`, `password`, `role`, `active`, `created_at`) 
    VALUES
        (1, 'byronadm',    ?, 'admin',    1, '2026-02-18 11:15:29'),
        (2, 'byronlib', ?, 'employee', 1, '2026-02-18 11:15:29')
	");
	$stmt->execute([$adminHash, $employeeHash]);
    ok("Default users inserted &nbsp;<code>byronadm / admin123</code> &nbsp;&amp;&nbsp; <code>byronlib / byron123</code>");
    ...
    <table style='font-family:sans-serif;font-size:14px;border-collapse:collapse;margin-bottom:16px'>
        ...
        <tbody>
            <tr>
                ...
                <td style='padding:6px 20px 6px 0'>byronadm123</td>
            ...
            <tr>
                ...
                <td style='padding:6px 20px 6px 0'>byronlib123</td>
